        ...
        children: [
          Container(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 12),
                Text(
                  (userData!['username'] ?? "No Name").toString().toUpperCase(),
                  style: const TextStyle(
                    fontSize: 22,
                    fontWeight: FontWeight.bold,
                    color: Colors.white,
          ...
          Padding(
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  _infoTile(icon: Icons.person, label: "Name", value: userData!['username']),
                  const Divider(color: appBottomColor),
                  _infoTile(icon: Icons.email, label: "Email", value: userData!['email']),
                  const Divider(color: appBottomColor),
                  _infoTile(icon: Icons.phone, label: "Phone", value: userData!['phone']),
                  const Divider(color: appBottomColor),
                  _infoTile(icon: Icons.home, label: "Address", value: userData!['address']),
                ],
              ),
            ),
          ),
